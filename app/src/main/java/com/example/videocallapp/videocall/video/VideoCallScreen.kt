...
fun VideoCallScreen(
    ...
    when {
        ...
        state.callState == CallState.JOINING -> {
            ...
            // here bluetooth for wireless connections like airpodes.
            // record audio for recording the audio.
            ...
            // CallContent inbuilt in stream Sdk
            CallContent(
                call = state.call,
                modifier = Modifier
                    .fillMaxSize(),
                permissions = rememberCallPermissionsState(
                    ...
                    onPermissionsResult = { permissions ->
                        if(permissions.values.contains(false)) {// collections of boolean if any of them is false then no videocall
                            Toast.makeText(
                                context,
